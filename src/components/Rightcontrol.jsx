  ...
  return (
    <div className="w-20 h-70 bg-red-600 rounded-r-3xl flex flex-col items-center justify-around py-6 border-4 border-red-800">
      ...
      <div className="relative w-14 h-14 pointer-events-none">
        ...
        <div 
          onClick={handleBack}
          className="pointer-events-auto absolute bottom-0 left-1/2 -translate-x-1/2 w-5 h-5 bg-green-500 rounded-full flex items-center justify-center text-xs font-bold text-green-900 cursor-pointer hover:bg-green-400">B</div>
        ...
        <div 
          ...
          className="pointer-events-auto absolute right-0 top-1/2 -translate-y-1/2 w-5 h-5 bg-red-400 rounded-full flex items-center justify-center text-xs font-bold text-red-900 cursor-pointer hover:bg-red-300">A</div>
      </div>
